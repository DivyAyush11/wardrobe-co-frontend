...
const ProductDisplay = (props) => {
    const { product } = props;
    const {addToCart} = useContext(ShopContext); // Assuming addToCart is passed as a prop
  return (
      ...
      <div className="productdisplay-left">
        ...
        <div className="productdisplay-right">
            ...
            <div className="productdisplay-right-size">
                ...
                <p className='productdisplay-right-category'><span>Tags: </span>Modern, Stylish</p>
            </div>
        </div>    
    </div>
  )
